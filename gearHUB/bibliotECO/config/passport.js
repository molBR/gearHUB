...
module.exports = function(passport) {
    ...
    function(req, siape,password, done) {
    ...
    function(req, siape, password, done) { // callback with email and password from our form
        ...
        User.findOne({ 'local.siape' :  siape}, function(err, user) {
            ...
            if (!user)
                return done(null, false, req.flash('loginMessage', 'SIAPE não econtrado.')); // req.flash is the way to set flashdata using connect-flash
